...
public class CounselorAdapter extends RecyclerView.Adapter<CounselorAdapter.CounselorViewHolder> {
    ...
    public CounselorAdapter(ArrayList<CounselorModel> counselorModels_local, Context context){
        mCounselorModels = counselorModels_local;
        mContext = context;
    }
    @NonNull
    @Override
    public CounselorAdapter.CounselorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.adapter_counselor_details, viewGroup, false);
        return new CounselorViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final CounselorAdapter.CounselorViewHolder counselorViewHolder, final int i) {
